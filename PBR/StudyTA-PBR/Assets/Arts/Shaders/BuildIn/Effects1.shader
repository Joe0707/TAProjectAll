Shader "jcy/Effects1"
{
    Properties
    {
        ...
        [Header(Distort)]
        [Toggle(DISTORTENABLED)]_DistortEnabled("Distort Enabled",int) = 0 
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature DISTORTENABLED
            ...
            v2f vert (appdata v)
            {
                ...
                o.uv.xy = TRANSFORM_TEX(v.uv, _MainTex)+ _Time.y*float2(_MainUVSpeedX,_MainUVSpeedY);
                #if _MASKENABLED_ON
                    o.uv.zw = TRANSFORM_TEX(v.uv,_MaskTex)+_Time.y*float2(_MaskUVSpeedX,_MaskUVSpeedY);
                #endif
                #if DISTORTENABLED
                    o.uv2 = TRANSFORM_TEX(v.uv,_DistortTex)+_Time.y*float2(_DistortUVSpeedX,_DistortUVSpeedY);
                #endif
