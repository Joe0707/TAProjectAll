...
namespace RenderHeads.Media.AVProMovieCapture
{
	...
	public class CaptureBase : MonoBehaviour
	{
		...
		protected virtual void Awake()
		{
			...
			#endif
			#elif UNITY_IOS && !UNITY_2017_1_OR_NEWER
		...
		protected void GenerateFilename()
		{
			...
			else if (_outputType == OutputType.ImageSequence)
			{
				...
				filename = GenerateTimestampedFilename(_filenamePrefix, null) + "/frame" + string.Format("-%0{0}d.{1}", _imageSequenceZeroDigits, Utils.GetImageFileExtension(_imageSequenceFormat));
			}
