	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 triplanar2 = TriplanarSampling2( _TopTexture0, WorldPosition, ase_worldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				
				
				finalColor = triplanar2;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=3C55A0C0216216305DFEFC63A9B8640BE13540B7